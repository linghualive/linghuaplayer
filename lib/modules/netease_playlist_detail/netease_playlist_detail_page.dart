...
import 'netease_playlist_detail_controller.dart';

class NeteasePlaylistDetailPage extends StatelessWidget {
  const NeteasePlaylistDetailPage({super.key});
  ...
  Widget build(BuildContext context) {
    final controller = Get.find<NeteasePlaylistDetailController>();
  ...
  Widget _buildHeader(BuildContext context,
      NeteasePlaylistDetailController controller, ThemeData theme) {
